...
// Publications now live in src/data/publications.ts — the single source of
// truth for all research and press listings and counts.
...
export const services: Service[] = [
  ...
  { id: 'defence-acquisition', title: 'Defence Acquisition & System Acquisition', shortDesc: 'Specialist advisory for system acquisition, defence programme management, and lifecycle delivery.', description: 'Drawing on extensive leadership experience at Heavy Industries Taxila (HIT), Pakistan\'s premier defence manufacturing complex, Dr. Waseem Ali Tipu brings specialised expertise in system acquisition processes, defence programme management and procurement, lifecycle management, and strategic programme delivery for complex national projects.', icon: '⚙️', features: ['System Acquisition Processes','Defence Programme Management','Strategic Procurement','Product & System Lifecycle Management','Complex Programme Delivery','Governance & Oversight','Supplier & Stakeholder Coordination','Risk, Cost, Schedule & Performance Control'], outcome: 'Capability delivered on time, within budget, and through transparent process.' },
...
export const pageMeta = {
  ...
  contact: { eyebrow: 'Contact', title: 'Start the Conversation', subtitle: 'Reach WATPRO Consultants for advisory, training, and partnership enquiries.', description: 'Reach WATPRO Consultants for advisory, training, and partnership enquiries.' },
};
